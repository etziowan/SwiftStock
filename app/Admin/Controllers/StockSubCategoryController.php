...
class StockSubCategoryController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('current_quantity', __('Current Quantity'))
            ->display(function ($current_quantity) {
                return number_format($current_quantity) . ' ' . $this->measuring_unit;
            })->sortable();
        $grid->column('reorder_level', __('Reorder Level'))
            ->display(function ($reorder_level) {
                return number_format($reorder_level) . ' ' . $this->measuring_unit;
            })->sortable()
            ->editable();
    ...
    protected function detail($id)
    {
        ...
        $show->field('measuring_unit', __('Measurement unit'));
    ...
    protected function form()
    {
        ...
        $form->text('measuring_unit', __('Measurement Unit'))
            ->rules('required');
