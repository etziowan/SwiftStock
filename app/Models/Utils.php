    ...
    static public function demo_stock_records($company)
    {
        ...
        foreach ($stock_items as $key => $stock_item) {
            ...
            foreach ($stock_records as $key => $stock_record) {
                ...
                $stock_record['measuring_unit'] = 'Kg';
...
*/
    ...
    static public function demo_sub_categories($company)
    {
        ...
        foreach ($categories as $key => $category) {
            $sub_categories = [
                ['name' => 'Sub Category 1', 'description' => 'Sub Category 1', 'status' => 'active', 'measuring_unit' => 'Kg', 'reorder_level' => 10],
                ['name' => 'Sub Category 2', 'description' => 'Sub Category 2', 'status' => 'active', 'measuring_unit' => 'Kg', 'reorder_level' => 10],
                ['name' => 'Sub Category 3', 'description' => 'Sub Category 3', 'status' => 'active', 'measuring_unit' => 'Kg', 'reorder_level' => 10],
                ['name' => 'Sub Category 4', 'description' => 'Sub Category 4', 'status' => 'active', 'measuring_unit' => 'Kg', 'reorder_level' => 10],
                ['name' => 'Sub Category 5', 'description' => 'Sub Category 5', 'status' => 'active', 'measuring_unit' => 'Kg', 'reorder_level' => 10],
            ];
            foreach ($sub_categories as $key => $sub_category) {
